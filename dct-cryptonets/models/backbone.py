...
all_network_perturbations = {
    ...
    '64_24_32': {  # ResNet50 with 24 DCT channels, 32x32 spatial
        'conv1_kernel': 1,
        'conv1_stride': 1,
        'conv1_padding': 0,
        'relu1': False,
        'pool1_kernel': None,
        'pool1_stride': None,
        'avgpool_kernel': 1,  # 32/(2^5) = 1, where 2^5 comes from 5 downsampling operations
    },
    '64_48_32': {  # ResNet50 with 48 DCT channels, 32x32 spatial
        'conv1_kernel': 1,
        'conv1_stride': 1,
        'conv1_padding': 0,
        'relu1': False,
    ...
    '64_64_32': {  # ResNet50 with 64 DCT channels, 32x32 spatial
        'conv1_kernel': 1,
        'conv1_stride': 1,
        'conv1_padding': 0,
        'relu1': False,
    ...
    '64_24_64': {  # ResNet50 with 24 DCT channels, 64x64 spatial
        'conv1_kernel': 1,
        'conv1_stride': 1,
        'conv1_padding': 0,
        'relu1': False,
        'pool1_kernel': None,
        'pool1_stride': None,
        'avgpool_kernel': 2,  # 64/(2^5) = 2
    },
    '64_48_64': {  # ResNet50 with 48 DCT channels, 64x64 spatial
        'conv1_kernel': 1,
        'conv1_stride': 1,
        'conv1_padding': 0,
        'relu1': False,
    ...
    '64_64_64': {  # ResNet50 with 64 DCT channels, 64x64 spatial
        'conv1_kernel': 1,
        'conv1_stride': 1,
        'conv1_padding': 0,
        'relu1': False,
    ...
    '64_192_32': {  # ResNet50 with all 192 DCT channels, 32x32 spatial
        'conv1_kernel': 1,
        'conv1_stride': 1,
        'conv1_padding': 0,
        'relu1': False,
    ...
    '64_192_64': {  # ResNet50 with all 192 DCT channels, 64x64 spatial
        'conv1_kernel': 1,
        'conv1_stride': 1,
        'conv1_padding': 0,
        'relu1': False,
